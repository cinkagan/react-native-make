 ...
 */
const res = lstatSync(resolve('.', 'node_modules', 'react-native-customize-app'));
if (res.isSymbolicLink()) {
  console.warn('Detected linked install of react-native-customize-app, compiling at runtime...');
